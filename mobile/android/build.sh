#!/bin/bash
# Build Skunkcord Rust library for Android
...
echo "  target/aarch64-linux-android/release/libskunkcord.so"
echo "  target/armv7-linux-androideabi/release/libskunkcord.so"
echo "  target/x86_64-linux-android/release/libskunkcord.so"
echo ""
echo "Copy these into your Android project's jniLibs/ directory:"
echo "  app/src/main/jniLibs/arm64-v8a/libskunkcord.so"
echo "  app/src/main/jniLibs/armeabi-v7a/libskunkcord.so"
echo "  app/src/main/jniLibs/x86_64/libskunkcord.so"
